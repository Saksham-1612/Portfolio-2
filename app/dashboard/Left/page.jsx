...
import { SiAdobe, SiOnlyoffice } from "react-icons/si";
        ...
        <div className=" md:w-80 w-full p-3 border border-neutral-800   rounded-2xl h-full bg-[#1C1C1C]  ">
          ...
          <div className="w-full mt-5 text-neutral-300">
            ...
            <p className="text-[12px]  font-RubikRegular my-3">
              At Paperclip Technologies, I'm a Next.js developer skilled in the
              MERN stack with two patents.
              <br /> I optimize data structures and design user-friendly
              experiences, driving web development innovation.
            </p>
            ...
            <div className="my-4 ">
              ...
              <div className="my-3 flex  justify-between">
                <div className="flex gap-x-3">
                  ...
                  <div className="-mt-1">
                    <h3 className="text-sm font-RubikMedium">Next JS Intern</h3>
                    <p className="text-[9px]">
                      Paprclip Technologies Pvt. Ltd.
                    </p>
                  </div>
                </div>
                <small className="text-[9px] text-neutral-300">
