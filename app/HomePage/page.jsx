          ...
          <div className="flex gap-x-6 p-4">
            ...
            <div>
              <h1 className="text-2xl font-RubikMedium text-neutral-300">
                Semicolon,{" "}
                <span className="text-sm text-neutral-400">My Timeline</span>
              </h1>
              <p className="max-w-sm text-neutral-400 text-sm">
                Navigating the digital landscape with finesse, I'm a full stack
                web developer on a mission to create seamless online
                experiences. From front-end design to back-end functionality, I
                architect and execute solutions that merge elegance with
                efficiency.
              </p>
            </div>
          </div>
